...
\item \textit{Experiential learning related assignments:} (i) short reflective on-site assignments (20 points total), (ii) individual research project (50 points). The course project will include a proposed question and exploratory paper (5 points), literature review (10 points), presentation (10 points), and final paper (15 points). The project will incorporate material from the trip.

\item \textit{Course evaluations} completed online. 3 points extra credit for successful completion.

\item \textit{Grade Distribution:} Participation--0.5 point per class (10 total); Gobbets--5 points each (30 total); travel related  (60 total).
...
[2.] Early Greek science (1/27)	  	& No Assign.			& -- \href{https://scottoconnor.org/ancient/Shields2.pdf}{`Philosophy Before Socrates', C. Shields, Ch.1} online  \\ [1.8\baselineskip]

[3.] S on knowledge (2/3)			& Gobbet 1		& --`Euthyphro'  (in RAG) \\
			        				&			  	&  --`Meno' (in RAG) \\ [1.8\baselineskip] % (\emph{Meno's slave receives a geometry lesson}) \\ 
...
\textbf{No class on Monday}						 & 			      & \\ [1.8\baselineskip] % (\emph{discussion of harmony}) 

[6.] Continued (2/24) 	& Expl. Essay	          & --`Phaedo', 69e--95a  (in RAG)   \\
						         & 				 & --`Phaedo', 95a--102a  (in RAG) \\ [1.8\baselineskip]
  
[7.] S on immortality (3/2)	  		& Gobbet 4		 & --`Phaedo', 102b--118a  (in RAG)   \\
							& 				 & --`Socrate', 2nd half (in class)' \\ [1.8\baselineskip] 

[8.] Greece (3/6-3/15) 			& 				 &  					\\
Or alternative 					& 				 &   					\\ [1.8\baselineskip]	

[9.] \textbf{No classes} (3/16) 		& Research Q		 &  					\\
					 		& 				 &   					\\ [1.8\baselineskip]	


[10.] Plato 1 (3/23)			 	& Gobbet 5			& --Glaucon's Challenge, `Republic', Book 2, 357a--369a (in RAG)  \\ 
\textbf{Ethics Wed}				& 	        			& \\  [1.8\baselineskip]
				     			 


[11.] Plato 2	(3/30)			& Gobbet 6			& --Justice in the City, `Republic', Book 2, 369a--377d; Book 4, 427d--434d (in RAG)  \\
	            					&					& --Justice in the Soul, `Republic', Book 4, 434d-445e (in RAG)   \\  [1.8\baselineskip]
							%(\emph{phil of math, hypotheses, inducation, etc.})

[12.] Plato 3	(4/6)				& Project Draft 1		& --Philosophers must rule, `Republic', Book 6 (in RAG)  \\
		            				&		   			& --A ruler's education, `Republic', Book 7 (in RAG)  \\    \\ [1.8\baselineskip]
                                  			      
%--Four types of injustice, `Republic', Book 8 \& 9 up to 580c (in RAG)
%(\emph{math education, types of math distinguished})

[13.] A on knowledge (4/13)		& Gobbet 	7			& --`Posterior Analytics', Book 1.1--6, (in RAG) \\
						    	&  					& --`Physics', Book 1.1, Book 2 (in RAG) \\
							&					& --`Parts of Animals', Book 1.1 \& 1.5 (in RAG)	 \\ [1.8\baselineskip]
                                    

[14.] A's science 		(4/20)	& Gobbet 8			& -- `Physics', Book 6 (in RAG) \\ 
