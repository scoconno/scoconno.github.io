...
The elenchus					&					&  --`Meno' (in RAGP) \\ % (\emph{Meno's slave receives a geometry lesson}) \\ 
The paradox of inquiry			&					& \\[1.8\baselineskip]  \hline % (\emph{Meno's slave receives a geometry lesson}) \\ 
...
[8.] Continued(10/18)		 	& Paper 1	    	 &  --`Phaedo', 95a--118a  (in RAGP) \\  % (\emph{discussion of harmony} has to be collapsed
Forms and explanations			& 				    	 &  \\ [1.8\baselineskip]  \hline % (\emph{discussion of harmony} has to be collapsed
...
[12.] A's predecessors (11/15)			& Readings Qs 9 	& -- \href{https://scottoconnor.org/ancient/Shields2.pdf}{`Philosophy Before Socrates', C. Shields, Ch.1} online  \\ %forms
