...
\date{7/26/2020--08/26/2020}

\published{\textbf{Phil 140 (7044), 3 credits, Summer III 2021, Online}}
...
\item \textit{5 problem sets} administered through Blackboard. These comprise two parts. The first has 20 multiple choice questions on the assigned reading. The second has 2-3 short answer questions. There is a separate link in Blackboard for each part. Extra credit questions are offered in some weeks. 
...
(8/05)					& 				&  `The Star', Clarke, pp.131--133 \\[10pt] 
...
(8/19)					&				&  **`A Horseman in the Sky', Pierce \\ [10pt] 
						\end{longtable}
\end{center}
