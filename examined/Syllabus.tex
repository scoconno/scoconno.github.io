...
\published{\textbf{Phil 140-3 (1791), 3 credits, Fall 2017, W 4:00pm--6:45pm}}
...
\item \textit{Signature assignment} submitted through the TK20 site.
...
\item \textit{Writing center visit} 2 
  
\item \textit{Grade distribution:} Attendance--0.5 points per class (10 maximum); Quizzes---10 points each (50 total);  Essays---10 points each (50 total)
...
(11/15/17)					&				& `They're Made out of Meat', Bisson, pp.225--227 \\ [1.8\baselineskip]
