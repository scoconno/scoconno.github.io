...
\begin{itemize}
\item
  \href{https://www.amazon.com/dp/0190852348/ref=cm_sw_em_r_mt_dp_U_XPl.EbST4MM5M }{`Philosophy  Here and Now: Powerful Ideas in Everyday Life', 3rd Edition, by Lewis Vaughn}  (Available to rent and purchase online.)
\end{itemize}
...
\item \textit{5 reading quizzes} administered through Blackboard. 

\item \textit{5 short written assignments} submitted through Blackboard.  
...
\item \textit{Grade distribution:} Quizzes---10 points each (40 total);  Short written assignments---10 points each (50 total)
...
\item \textit{Late work \& Make-up Policy:} See the assignment schedule below. No late work accepted under any circumstances. One make-up allowed: if you miss a module, you may make it up by the end of the semester. No exceptions under any imaginable circumstances.
...
[1.] The Examined Life		& Quiz 1			&  Ch.1 \\
(7/27/)					& W. Assign. 1		&  `The Trial and Death of Socrates', Plato, pp.47-53  \\  [1.8\baselineskip]

[2.] A Meaningful Life			& Quiz 2 			&  Ch.9; Ch.2.6 (Eastern religion, but how much?) \\
(7/30)					& W. Assign. 2		&  `The Good Brahmin',Voltaire, pp.429--430 \\
						&				& **`A Confession', Tolstoy, pp.13--93 (optional)\\ [1.8\baselineskip]

[3.] A Religious Life		 	& Quiz 3			& Ch.2.1--2.3\\ 
(8/06)					& W. Assign. 3		& **`Intelligent Design Has No Place in the Science Curriculum', Morowitz, Hazen, and Trefil\\
						&				& **`Design for Living', Behe\\  
						&				& **`Surprise! It's Judgment Day',  Davis \\
						&				& `The Star', Clarke, pp.126--128 \\ [1.8\baselineskip]
							
[4.] A free life				& Quiz 4			& Ch.5\\
(8/13)					& W. Assign. 4		&  `A Little Omniscience Goes a Long Way', Davis, pp.258--261 \\  
						&				& **`Please Don't Tell Me How The Story Ends', Davis \\  [1.8\baselineskip]

[5.] An Ethical Life			& Quiz 5			& Ch.3 \\
(8/20)					& W. Assign. 5		& **`Kirinyaga', Mike Resnik, ch.1 \\ 
						&				& `The Ones Who Walk Away from Omelas', Le Guin, pp.191--194 \\ 												&				&  `A Horseman in the Sky', Pierce \\ 
