...
\frame{\frametitle{Agenda} \tableofcontents[tableofcontents]}

\section{Survival \& Immortality}
...
Despite their qualitative differences, what is it about G that makes her the very same person as P?
...
\frame{\frametitle{Problems}
   \begin{itemize}
   \item  A person A at one time is identical to  a person B at a later time iff the soul of A is identical to the soul of B. \pause
...
\begin{block}{Claim}
\begin{itemize}
\item[S] Same psychology entail same soul.  \pause
