...
These passages indicate that there are three ways to describe any change:
...
Despite appearances, Aristotle thinks that A, B, and C really only describe one thing: a case where a man goes from being unmusical to musical. But the most important upshot for us will concern non-existence. 
...
Aristotle claims here that the entity that changes is distinct from the opposites the change occurs between. When the unmusical becomes musical, the unmusicality is different from the student who has yet to learn music; they student, being musical, and being unmusical are distinct entities. 

Changes are changes of place (locomotion), of degree (growth), of
quality (alteration), or of substance (generation). These are collectively called qualified changes. In qualified changes, it is easy to identify an enduring subject and those opposites they occur between. 




## Generation & Destruction: Hylomorphism

The problem, though, is how to apply this model to generation and destruction: what is the subject and the pair of opposites involved in generation and destruction? Aristotle's answer has two parts. First, he emphasizes that there is a difference between substances and their predicates, and he claims that, strictly, it is only substances that are generated and destroyed. Second, he argues that the opposites and subject involved in substantial change are a special trio of entities: matter, form, and privation. 

#### Short Tangent on Substance

According to Aristotle, the only entities that truly are generated and destroyed are substances. Other entities, like colors, shapes, etc., are never generated or destroyed. So, what are substances. 
...
In general, Aristotle accepts a version of *hylomporhpism*, a metaphysical view on which (almost) all existing things are composites of matter and form.

*Matter*
> "That from which, as present in it, a thing comes to be". 

Generally, he calls the matter the underlying material. The bronze and silver are material causes of the statue and the bowl. So too are letters of syllables, matter of artifacts, fire and such things of bodies, parts of wholes, and premises of a conclusion.

*Form*

> "The form (i.e. the pattern)\... The form is the account (and the genera of the account) of the essence, and parts in that account".   

The form is roughly what you refer to in explaining what something is. It is a set of capacities that jointly constitute what it is to be something of a certain kind, e.g., the capacities that jointly constitute being a human being.
