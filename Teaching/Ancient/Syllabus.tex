...
\def\mytitle{{\normalsize Phil 234-1 (2693), 3 credits, Spring 2016, M\&W 16:00--17:15, H220 \newline} \HUGE Ancient Philosophy}
...
\end{itemize}
\subsection{Optional}
Since this is a 200 level class, class time will not be spent on the mechanics of writing. Students who wish to improve their writing might wish to purchase and work through the 10 lessons contained in the following: 
\begin{itemize}
...
\item \emph{Wed.} Justice in the City, 
\end{enumerate}
\item[\textbf{Spring Break}] \

\item[\textit{Week 8}] `The Republic'
\begin{enumerate}
\item \emph{Mon} Justice in the Soul, `Republic', 434d-445e
\item \emph{Wed.} Philosopher Kings, `Republic', VII
\end{enumerate}
\end{enumerate}
