...
\begin{itemize}
\item Taking any course at NJCU requires some computer literacy, e.g., the ability to check send and receive e-mail, access website, upload and download documents. If these tasks are difficult for you, please find some resources at \href{http://www.njcu.edu/it/helpdesk/}{\href{http://www.njcu.edu/it/helpdesk/}. Technical difficulties are no excuse for missed or late work. 


\section{Requirements}

\begin{itemize}
\item \textit{Workload:} You are expected to attend every class meeting fully prepared to discuss each assigned reading, to submit written work punctually, and to offer thoughtful and constructive responses to the remarks of your instructor and your classmates. Make sure that you bring the relevant readings with you to every class. I further expect you to treat both the texts at hand and your classmates’ ideas with openness and respect.
