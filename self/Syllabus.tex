...
\item \textit{5 essays (500--750 words)} submitted through Blackboard. Modules 3 and 5 each contain two options. You must complete either 3a or 3b, and you must complete either 5a or 5b. Your last submitted essay will serve as your signature assignment. Essays submitted by the due date will receive an on-time bonus of 3 points, e.g., an essay that received 83\% submitted on-time will be increased to 86\%. Essays can be submitted after the due date without penalty up until the last day of the term. % If you complete more than 5, the lowest grades will be dropped (NB: you must complete at least one essay before spring break, i.e., one of essays 1--3).
...
\item \textit{Late work \& Make-up Policy:} See the assignment schedule below. No late quizzes accepted under any circumstances. Essays will be accepted up until the last day of the term. Essays submitted by the due date receive a 3 point on-time bonus. 
...
Readings marked with a `**' can be found on the course website. All other listed readings can be found in the required textbook. Changes to the syllabus will be announced through Blackboard. Listed dates indicate the start of a module.  All assignments must be submitted at 11:59pm seven days after a module opens, e.g., module 1 opens on Wednesday, 6/28 and both essay 1 and quiz 1 are due on Tuesday, 7/4 at 11:59pm.  \newline
\begin{center}
\begin{longtable}{p{3.5cm}p{1.25cm}p{8cm}}
...
(7/05)					 & Essay 2		& --DIAL, \emph{Monday}, pp.1--23  \\   
 [.5\baselineskip] \midrule

\emph{Complete 3a \textbf{or} 3b}	& 		& 	\\ [.5\baselineskip]

[3a.] Behaviorism		    	& Quiz 3a	   	& --Kim, ch.3, pp.61--87 \\
(7/12)			        			& Essay 3a	&  --\emph{**The Concept of Mind}, Gilbert Ryle\\ [.5\baselineskip]   
