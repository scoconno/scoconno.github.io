...
\item \textit{5 essays (500--750 words)} submitted through Blackboard. Modules 3 and 5 each contain two options. You must complete either 5a or 5b. Your last submitted essay will serve as your signature assignment. % If you complete more than 5, the lowest grades will be dropped (NB: you must complete at least one essay before spring break, i.e., one of essays 1--3).
