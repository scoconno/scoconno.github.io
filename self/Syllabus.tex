...
\published{\textbf{Phil 236-1 (2329), 3 credits, Spring 2019, Online}}
...
Readings marked with a `**' can be found on the course website. All other listed readings can be found in the required textbook. Changes to the syllabus will be announced through Blackboard.  All assignments must be submitted at 11:59pm on the last day of the week, e.g., quiz 1 is due on 2/3/19 at 11:59pm. No late work accepted. No exceptions.   \newline
...
(2/18/19)				        	& (due 2/24)		&--DIAL, \emph{Monday}, pp.13--23 \\  [1.8\baselineskip]
