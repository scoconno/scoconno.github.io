...
by Blackboard.
\item \textit{Discussion Questions:} 3 discussion questions submitted to the discussion board. Answers will be made public to the entire class after the due date. 

\item \textit{Essays:} Two essays throughout the summer. Essays are graded according to a rubric that can be found at the end of this syllabus. 
