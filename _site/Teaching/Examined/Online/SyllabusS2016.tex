...
\begin{enumerate}
\item **`A Horseman in the Sky', Ambrose Pierce\footnote{Updated from `Billy Budd'.}
\item Ch.3.4
...
\item \textit{04/11/2016,}  \href{http://scoconno.github.io/Teaching/Examined/FreeWill/SW/}{Short essay 4---Free will}\footnote{Originally due 4/4/2016. Changed due to error on course website.}
