...
\def\myweb{\href{http://scoconno.github.io/Teaching/Examined/HARB}{http://scoconno.github.io/Teaching/Examined/Online}}
\def\myphone{}
\def\myversion{}
\def\myrevision{}
\def\myaffiliation{NJCU}
...
\def\mytitle{{\normalsize Phil 140, 3 credits, Fall 2015, Online. \newline} \HUGE The Examined Life}
...
\item \textit{8 Quizzes} administered through Blackboard. 

\item \textit{3 Short Writing Assignments} submitted through Blackboard. 

\item \textit{2 Essays} submitted through Blackboard. 
 
\item \textit{Grade Distribution:}  Quiz---5 points each (40 total);  Short Writing Assignments---10 points each (30 total); Essays---20 points each (40 points total); 
...
\item Perhaps I should beef up this and merge with module 2. I would have them write about the apology. 
\end{enumerate}
\end{enumerate}
...
\begin{enumerate}
\item Ch.5.1--5.2
\item **`Do Androids Dream of Electric Sheep', Philip, K. Dick (extract TBD) (something else) 
...
\item \textit{Week 14,} Virtue Ethics (beef up ethics)
\begin{enumerate}
\item Ch.3.4--3.5
\end{enumerate}
\end{enumerate}
...
All assignments must be submitted through Blackboard by 1:00pm on beginning week. No late work accepted. No make-ups. No exceptions. 
...
\item \textit{11/20/2015,} \href{http://scoconno.github.io/Teaching/Examined/Ethics/Essay/}{Essay 2---Ethics}
\end{enumerate}
