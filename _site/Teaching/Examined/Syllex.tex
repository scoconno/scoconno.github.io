...
\published{\textbf{Phil 140-1 (3042), 3 credits, Fall 2016, ROOM}}
...
\item[\textit{Week 4}: ] The Meaning of Life--Optimism 
\begin{enumerate}
\item Ch.9.3
...
\item[Week 5: ] The Existence of God-The Design Argument
\begin{enumerate}
...
\item[Week 6:] Further Arguments for God's Existence
\begin{enumerate}
\item Extra reading
\item Ch.2.2
\end{enumerate}
...
\item[Week 7:] The Problem of Evil 
\begin{enumerate}
\item Extra reading
...
\item[Week 8:] Free Will and Determinism
\begin{enumerate}
\item Extra reading
\item Ch.5.1, 5.2, and 5.4.
\end{enumerate}

\item[Week 9:] Compatibilism
\begin{enumerate}
\item Extra reading
...
\item[Week 10:] Cultural Relativism
\begin{enumerate}
\item **`Kirinyaga', Mike Resnik, ch.1
\item Ch.3.1--3.2
\end{enumerate}
\item[Week 11]  Consequentialism 
\begin{enumerate}
\item  `The Ones Who Walk Away from Omelas', Ursula Le Guin, pp.191--194 
\item Ch.3.3
\end{enumerate}
\item[Week 12]  Deontology \& Virtue Ethics
\begin{enumerate}
...
\item[Week 13]  Group Projects
\begin{enumerate}
\item Sundry 
\end{enumerate}

\item[Week 14] Group Project
\begin{enumerate}
\item Prep on Mon  
\item Presentations on Wed
\end{enumerate}

\item[Week 15] Group Project
\begin{enumerate}
