...
Each General Education course teaches two of the six university-wide student learning goals in at least one of the four modes of inquiry at one of three tiers. You can find more information at \href{http://www.njcu.edu/cas/general-education/}{http://www.njcu.edu/cas/general-education/}.This course has the following attributes:
\begin{itemize}
\item \textit{Mode:} Language, Literary, and Cultural Studies 
\item \textit{Tier:} 1
\item \textit{University-wide Learning Goals:}(1) Critical Thinking and Problem Solving, (2) Written Communication.
\end{itemize}
...
\item \textit{Final group project} consisting of a literature, oral presentation, and written submission. Each member must present at least one slide. Groups will grade their member's participation.
...
\item Blackboard difficulties are rare and automatically reported to instructors. Under no circumstance will a student's report of a Blackboard difficulty be reason for an extension. It is your responsibility to contact blackboard support for help.
\end{itemize}
...
\item[Module 4: ] The Existence of God
...
\item[Module 6:] Normative Ethics
\begin{enumerate}
