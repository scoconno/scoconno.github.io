...
\def\mytitle{{\normalsize Phil 260 ( \ \  \  \  \  \  \   \  \  \  \ ), 3 credits,  Semester: \newline} \HUGE Philosophy of Education }
...
Upon completing this course, students will be able to (i) apply philosophical concepts to pragmatic examples. For example, how do the insights of Aristotle continue to inform science education? (ii) Evaluate educational research, policy and journalism using the tools of philosophy, informal logic and critical thinking. (iii) Apply ethical concepts and ethical thought to education and education policy. (iv) Compare competing ethical perspectives as they apply to learning, intellectual growth and educational policy. (v) Appraise arguments that relate to educational innovation and reform. (vi) Develop a stronger sense of empathy and personal responsibility regarding educational systems and education across cultures.


\section{General Education Information} 
Successfully completing this course satisfies one Tier 2 Social and Historical Perspectives requirement and one Tier 2 Language, Literary, and Cultural Studies. It teaches the following three University-wide Learning Goals: (1) Information and Technological Literacy, (2) Written Communication, (3) Civic Engagement and Intercultural Knowledge. For further information about the General Education Program see: \\
 \href{http://www.njcu.edu/cas/general-education/}{http://www.njcu.edu/cas/general-education/}.
